<template>
	<view>
		...
		<view :class="{
		 ...
		 class="uni-fab__circle uni-fab__plus" :style="{ 'background-color': styles.buttonColor }" @click="_onClick" @longpress="onLongPress">
			<u-icon :name="buttonIcon" color="#ffffff" size="56"></u-icon>
